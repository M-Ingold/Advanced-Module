...
REF_GENOME=../../data/References/potato_dm_v404_all_pm_un.fasta
...
OUT_PATH_BAM=../../data/GWAS_data/Final_BIG_GBS/alignment_data_4.4
mkdir -p $OUT_PATH_BAM
# Creating and specifying the directory for the alignment statistics
OUT_PATH_STAT=../../analysis/alignment_data_4.4
