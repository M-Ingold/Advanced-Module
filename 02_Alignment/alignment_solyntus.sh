...
REF_GENOME=../../data/References/SolyntusV1.1.fasta
...
OUT_PATH_BAM=../../data/GWAS_data/Final_BIG_GBS/alignment_data_solyntus
mkdir -p $OUT_PATH_BAM
# Creating and specifying the directory for the alignment statistics
OUT_PATH_STAT=../../analysis/alignment_data_solyntus
