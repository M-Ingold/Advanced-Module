...
VCF_PATH=../../data/GWAS_data/Final_BIG_GBS/variant_calls_GWAS_tetraploid
TARGET_FILE=SNP_count_tetraploid.txt

touch $TARGET_FILE
> $TARGET_FILE

max=$(grep -cv '#' $VCF_PATH/freebayes_192_samples_chr09_tetraploid.vcf)
