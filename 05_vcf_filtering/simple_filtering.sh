...
PATH_IN=../../data/GWAS_data/Final_BIG_GBS/variant_calls_GWAS

# Filtering out non-SNP variants
#vcffilter -s -f "TYPE = snp" $PATH_IN/freebayes_192_samples_09.vcf > $PATH_IN/freebayes_192_samples_09_SNPs.vcf
...
#bcftools view -g  ^miss $PATH_IN/freebayes_135_samples_09_SNPs_QUAL_30_depth_depth_gt_61_missing_0.9_1_read.vcf \
#>

# Minor Allele called at least once
bcftools view --min-ac=1:minor $PATH_IN/freebayes_135_samples_09_SNPs_QUAL_30_depth_depth_gt_61_missing_0.9_1_read.vcf \
> $PATH_IN/61_filtered.vcf

# Output genotype matrix
#vcftools --vcf $PATH_IN/61_filtered.vcf --012