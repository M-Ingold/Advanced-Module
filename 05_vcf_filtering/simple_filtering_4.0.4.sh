...
PATH_IN=../../data/GWAS_data/Final_BIG_GBS/variant_calls_GWAS_using_4.4

# Filtering out non-SNP variants
#vcffilter -s -f "TYPE = snp" $PATH_IN/freebayes_192_samples_09_4.4.vcf > $PATH_IN/freebayes_192_samples_09_SNPs.vcf
